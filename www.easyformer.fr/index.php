        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 wow fadeInRight">
					...
					<p>Vos projets peuvent être nos challenges.</p>
                        ...
                        <div class="panel-group" id="accordion1">
                              ...
                              <div class="panel-body">
                                  <div class="media accordion-inner">
                                        ...
                                        <div class="media-body">
                                             ...
                                             <p>C'est en consultant les experts métiers et les pédagogues de renom que l'on parvient à une pertinence technologique.</p>
                                        </div>
                                  </div>
                              </div>
                            </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseTwo1" class="panel-collapse collapse">
								<div class="panel-body">
									<p>Tout est mis en oeuvre pour maximiser l'efficience de la production. Prêt de matériel, licences et outils.</p>
								</div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseThree1" class="panel-collapse collapse">
                              <div class="panel-body">
                                <p>Dix années d'expertise ont été mis à profit dans près d'une centaine de projets innovants.</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="panel panel-default">
                            ...
                            <div id="collapseFour1" class="panel-collapse collapse">
								<div class="panel-body">
								   <p>Concentrez-vous sur votre métier. Nous sommes à votre disposition pour vous accompagner dans l'élaboration de votre système d'information.</p>
								</div>
                            </div>
                          </div>
                        </div><!--/#accordion1-->
        ...
        <div class="container">
			<div class="col-lg-12">		
				<ul class="portfolio-filter text-center">
					...
					<li><a class="btn btn-default" href="#" data-filter=".securite">Sécurité</a></li>
					<li><a class="btn btn-default" href="#" data-filter=".reseaux">Réseaux</a></li>
					...
					<div class="portfolio-items">
						...
						<div class="portfolio-item conception col-xs-12 col-sm-4 col-md-3">
							<div class="recent-work-wrap">
								...
								<div class="overlay">
									<div class="recent-work-inner">
										<h3><a href="#">Base de données</a></h3>
										<p></p>
						...
						<div class="portfolio-item conception virtualisation gestion col-xs-12 col-sm-4 col-md-3">
							<div class="recent-work-wrap">
								...
								<div class="overlay">
									<div class="recent-work-inner">
										<h3><a href="#">Ingeniérie logicielle</a></h3>
										<p></p>
			...
			<div class="row">
				<div class="center">
					<div class="col-md-6 col-md-offset-3">
						<h2>Nos projets</h2>
						<hr>					
						<p class="lead">Gateway vous guidera dans la conception, la réalisation et la finalisation de vos projets.</p>
					</div>
				</div>
				
				<div class="col-md-4 wow fadeInLeft">
					<h3>Ingénierie logiciel</h3>
					<img src="images/portfolio/recent/mcd.jpg" alt="">
					<p>Quelque soit la technologie nous trouverons les ressources qu'il vous manquent ainsi que les méthodes les mieux adaptées à votre structure.</p>
				</div>
				
				<div class="col-md-4 wow fadeInUp">
					<h3>Architecture Système et réseaux</h3>
					<img src="images/portfolio/recent/network.jpg" alt="">
					<p>Gateway collabore avec les plus grands équipementiers et spécialistes afin de préconiser des infrastructures de dernière génération.</p>
				</div>
				
				<div class="col-md-4 wow fadeInRight">
					<h3>Stockage et virtualisation</h3>
					<img src="images/portfolio/recent/stockage.jpg" alt="">
					<p>Au coeur de votre système d'information la donnée est votre bien le plus précieux. Gateway vous apportera des solutions professionnelles pour les gérer sécuritairement.</p>
				</div>
			</div>
		</div>		
	</section>
